...
Read [source-authority-checklist.md](../artifacts/source-authority-checklist.md) when you need source and authority checks.

## Output Contract

Return exactly: `Research Question`, `Jurisdiction And Scope`, `Sources Reviewed`, `Authority Map`, `Issue Spots`, `Caveats`, `Counsel Questions`, `Source Links`.

## Stop Conditions

Stop when asked to provide legal advice, determine legal rights, choose a legal strategy, file or submit legal materials, interpret privileged/confidential materials without authority, rely on non-public records, or act without counsel or authorized owner review.
