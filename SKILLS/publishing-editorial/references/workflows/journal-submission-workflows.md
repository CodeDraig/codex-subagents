...
2. Check scope fit and extract manuscript, metadata, reporting guideline, ethics, disclosure, data, figure, table, and file requirements from the journal instructions.
3. Build a submission checklist with owner, status, evidence, and unresolved questions, including any word, figure, supplement, and reference limits.
4. For revisions, map each reviewer comment to a response, manuscript location, evidence, and any remaining author decision.
5. Produce package gaps, submission blockers, and next actions; distinguish preparation from official portal submission.

Read [journal-submission-checklist.md](../artifacts/journal-submission-checklist.md) when you need submission readiness.
