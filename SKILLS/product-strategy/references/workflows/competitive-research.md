...
3. Record source owner, date checked, evidence type, and incentive bias. Use [source-quality.md](../artifacts/source-quality.md) when reliability or source incentives need explicit scoring.
