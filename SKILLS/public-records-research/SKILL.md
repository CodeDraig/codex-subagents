...
description: Use when searching official public records, corporate filings, court dockets, procurement notices, regulatory databases, sanctions lists, and registries; not for sealed, hacked, credentialed, paid-private, or irrelevant personal records.
---
...
Use `references/public-records-search-checklist.md` for source planning, identity matching, procedural language, retrieval evidence, and privacy review.
