...
This workflow helps keep a multi-slice implementation coherent. The goal is a clear execution order, stable ownership, and validation that matches the actual dependency graph.
...
Read [delivery-coordination-checklist.md](../artifacts/delivery-coordination-checklist.md) when you need execution planning and conflict boundaries.
