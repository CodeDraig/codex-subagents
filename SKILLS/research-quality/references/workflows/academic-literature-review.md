...
Read [literature-review-checklist.md](../artifacts/literature-review-checklist.md) when you need source and synthesis checks.
...
Hand study-design defects to `research-methods-review`, claim-level citation defects to `citation-integrity-review`, and domain conclusions requiring expert judgment to the named subject-matter reviewer.
