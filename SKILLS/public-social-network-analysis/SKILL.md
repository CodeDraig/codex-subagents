---
name: public-social-network-analysis
description: Use when analyzing public social-media networks, posting cadence, shared links, amplification chains, repeated phrasing, account-age signals, cross-platform reuse, and coordination patterns; not for deanonymizing users, inferring protected traits, target lists, or engagement tactics.
---
...
Use `references/public-network-analysis-checklist.md` for scope provenance, signal grading, alternative explanations, confidence, reproducibility, and privacy review.
