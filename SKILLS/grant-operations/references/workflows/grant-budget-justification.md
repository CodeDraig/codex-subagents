...
Support grant budget narratives by connecting costs to project work and sponsor rules. Do not approve budgets, certify costs, or provide institutional financial authority.
...
Read [budget-justification-checklist.md](../artifacts/budget-justification-checklist.md) when you need budget narrative checks.

## Output Contract

Return exactly: `Budget Context`, `Cost Map`, `Justification Draft`, `Assumptions`, `Restriction Flags`, `Consistency Checks`, `Owner Questions`.

## Stop Conditions

Stop when asked to certify allowability, approve rates, make tax or legal determinations, invent costs, bypass finance review, or submit official budget materials.
