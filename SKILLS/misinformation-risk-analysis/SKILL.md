---
name: misinformation-risk-analysis
description: Use when assessing false, misleading, unverified, out-of-context, satirical, manipulated, or coordinated public claims; tracing provenance and narrative spread; or designing proportionate non-amplifying corrections; not for generating deception, targeting persuasion, or harassment.
---
...
Use `references/misinformation-assessment-matrix.md` for classification, narrative-path evidence, amplification severity, and correction selection.
