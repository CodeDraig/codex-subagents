...
Read [media-location-time-checklist.md](../artifacts/media-location-time-checklist.md) when the analysis needs a formal artifact ledger, clue matrix, confidence assessment, or safety gate.
