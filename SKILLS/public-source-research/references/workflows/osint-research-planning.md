...
Read [osint-investigation-plan.md](../artifacts/osint-investigation-plan.md) when you need the scope gate, lane matrix, source tiers, evidence ledger, and synthesis review.
