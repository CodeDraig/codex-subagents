...
This workflow helps turn business definitions into durable analytics assets. Keep metric grain, ownership, transformation logic, null semantics, freshness, and dashboard behavior explicit.
...
Read [metrics-contract-checklist.md](../artifacts/metrics-contract-checklist.md) when defining a reusable metric or validating its transformation, dashboard, and change-management contract.
