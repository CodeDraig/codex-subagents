...
3. Review shape and semantics.
   - Read [contract-checklist.md](../artifacts/contract-checklist.md) when the review needs exhaustive request, response, error, authorization, pagination, idempotency, versioning, or observability coverage.
