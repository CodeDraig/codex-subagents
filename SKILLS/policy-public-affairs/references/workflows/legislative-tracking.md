...
Track legislative activity with source dates, official identifiers, status changes, and alert thresholds. Avoid legal advice and unsourced political claims.
...
Read [legislative-tracking-checklist.md](../artifacts/legislative-tracking-checklist.md) when maintaining a dated source, status, amendment, event, and owner-alert log.
...
Stop when asked to provide legal advice, infer confidential legislative strategy, fabricate status, or rely on unofficial sources as authoritative.
